				...
				<div id="content">
					<div class="post">
						<div class="post-content clearfix">
							...
							<div class="post-summary" align="center">
								<ul id="nav">
									...
									<li class="active"><a href="winRank.do">승 랭킹</a></li>
						...
						<table border="1">
									...
									<c:forEach var="winList" items="${winList }">
										<tr>
											<td align="center">${winList.rank }</td>
											<td align="center">${winList.userId }</td>
											<td align="center">${winList.win }판</td>
										</tr>
									</c:forEach> 
								</table>
						</div>
