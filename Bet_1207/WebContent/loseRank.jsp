				...
				<div id="content">
					<div class="post">
						<div class="post-content clearfix">
							...
							<div class="post-summary" align="center">
								<ul id="nav">
									...
									<li class="active"><a href="loseRank.do">패 랭킹</a></li>
									<li><a href="pointRank.do">포인트 랭킹</a></li>
								</ul>
							</div>
						</div>
						...
						<table border="1">
									...
									<c:forEach var="loseList" items="${loseList }">
										<tr>
											<td align="center">${loseList.rank }</td>
											<td align="center">${loseList.userId }</td>
											<td align="center">${loseList.lose }판</td>
										</tr>
									</c:forEach> 
								</table>
						</div>
