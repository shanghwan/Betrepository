               ...
               <div class="post">
                  <div class="post-head">
                     ...
                     <c:otherwise>
                           ...
                           <thead>
                              ...
                              <tr>
                                 ...
                                 <td><input type="radio" name="betWay" onClick="display1()" value="One" class="validate one team all" id="one">One(1vs1)
                                    ...
                                    <input type="radio" name="betWay" onclick="display2()" value="All">All(모두)</td>
                              </tr>
                              <tr>
                        ...
                        <br>
                       <strong><p>※ 포인트방식 안내</p></strong>
                        <br>
                        <p>올인 : 보유한 포인트를 모두 거는 위험하지만 익사이팅한 방법입니다.</p>
                        <p>자유 : 보유한 포인트 내에서 자유롭게 걸 수 있습니다.</p>
                        <p>고정 : 내기장이 정한 포인트만 걸 수 있습니다.</p>
                        <br>
                     </c:otherwise>
                     </c:choose>
                     <br>
