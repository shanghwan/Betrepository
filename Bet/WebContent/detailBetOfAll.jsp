   ...
   <div id="wrapper">
      <div id="container">
         ...
         <div align="right">
            ...
            내기장 아이디 : ${bet.betOwner }<c:if test="${bet.betOwner ne userId and bet.betOwner ne 'admin' }"><a onclick="showPopup2();">[신고]</a></c:if> <br> 내기 방식 : BetOf${bet.betWay } <br>
         ...
         <div id="main" class="clearfix">
            ...
            <br>
               ...
               <c:if test="${userId eq bet.betOwner or userId eq teamA.leader.userId}">
                ...
                <c:if test="${bet.state eq '진행' and bet.betOwner ne 'admin' }">    
                  <form action="gameJoin.do" method="post">
                     <input type="hidden" name="betId" value="${bet.betId }">
                     <input type="hidden" name="pointBet" value="${bet.point }">
                     <input type="hidden" name="betOwner" value="${bet.betOwner }">
                     <table>
                        <tr>
              ...
              <c:if test="${bet.state eq '종료' and bet.betOwner eq 'admin' }">
                  ...
                  <table>
                     <tr>
                        ...
                        <td><img class="imgs" src="/images/${bet.photoB }"
                           alt="이미지를 올려주세요" /> <br>
                        <br> 
                                 <input type="radio" name="vote" value="B">Team B
                           </td>
                     </tr>
                  </table>
                        <div align="center">
