					...
					<div class="post-head">
						...
						<div id=view1 style="display: none;">
							<form action="findBet.do">
								<input type="hidden" name="betWay" value="${betWay }"> <input
									size="50" type="text" name="betId" placeholder="내기번호을 입력하세요">
						...
						<div id=view2 style="display: none;">
							<form action="findBet.do">
								<input type="hidden" name="betWay" value="${betWay }"> <input
									size="50" type="text" name="betOwner" placeholder="내기장을 입력하세요">
								<input class="btn btn-xs btn-default" type="submit" value="검색">
							</form>
						</div>
						<div id=view3 style="display: none;">
							<form action="findBet.do">
								<input type="hidden" name="betWay" value="${betWay }"> <input
									size="50" type="text" name="title" placeholder="내기제목을 입력하세요">
								<input class="btn btn-xs btn-default" type="submit" value="검색">
							</form>
						</div>
					</div>
