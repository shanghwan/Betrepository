            ...
            <div id="content">
               <div class="post">
                  <div class="post-content clearfix">
                     ...
                     <div class="post-summary" align="center">
                        <ul id="nav">
                           ...
                           <li class="active"><a href="friendList.do">친구목록</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="table-responsive" align="center">
                     <form action="pwok.do" method="post">
                        <table class="table table-striped table-bordered table-hover">
                           ...
                           <tr>
                              ...
                              <td align="center">친구이름</td>
                              <td align="center">친구삭제</td>
                           </tr>
                           
                           <c:forEach items="${list }" var="list" varStatus="sts">
                           <tr>
 							  <td align="center">${sts.count }</td>
                              <td align="center">${list.friendId }</td>
                              <td align="center">${list.name }</td>
                              <td align="center"><a href="friendDelete.do?userId=${userId}&friendId=${list.friendId }">
                     ...
                     <br>
                     <br>
                     <button type="submit" class="btn btn btn-warning" onclick="showPopup();">친구 추가하기</button>
